...
async function UpdateAssetItem(name,id) {
...
export function BadgeGreen({name,itemid,title,trueBtn,falseBtn,onResult }) {
  ...
  const handleChangeStatus=()=>{
    if(UpdateAssetItem(name,itemid)){
...
export function BadgeBlue({name,itemid,title,trueBtn,falseBtn,onResult }) {
  const [toggle, setToggle] = useState(false);
